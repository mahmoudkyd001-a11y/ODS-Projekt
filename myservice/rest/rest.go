...
func NewHandler(e *echo.Echo) {
	...
	// 	spec, err := middleware.ParseOpenAPISpecFile("public/stores.yaml", e.AcquireContext())
	// 	if err != nil {
	// 		e.Logger.Fatal(err)
	// 	}
	...
	g.POST("/store", CreateStore)
	// Operations for: "/store"
	g.GET("/store", GetAllStores)

	// Operations for: "/store/:id"
	g.DELETE("/store/:id", DeleteStoreByID)
	// Operations for: "/store/:id"
	g.GET("/store/:id", GetStoreByID)
	// Operations for: "/store/:id"
	g.PUT("/store/:id", UpdateStoreByID)
