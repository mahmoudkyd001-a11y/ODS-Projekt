...
func NewHandler(e *echo.Echo) {
	...
	// 	spec, err := middleware.ParseOpenAPISpecFile("public/vacation.yaml", e.AcquireContext())
	// 	if err != nil {
	// 		e.Logger.Fatal(err)
	// 	}
	...
	// Operations for: "/urlaub"
	g.GET("/urlaub", GetUrlaubForm)
	// Operations for: "/urlaub"
	g.POST("/urlaub", CreateUrlaub)
