...
func CORSConfigFromEnv() echo.MiddlewareFunc {
	envOrigins := strings.TrimSpace(os.Getenv("BAUM_SERVICE_CORS_ALLOWED_ORIGINS"))
	credentialsEnv := strings.TrimSpace(os.Getenv("BAUM_SERVICE_CORS_ALLOW_CREDENTIALS"))
