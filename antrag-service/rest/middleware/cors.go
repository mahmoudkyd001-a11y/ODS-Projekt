...
func CORSConfigFromEnv() echo.MiddlewareFunc {
	envOrigins := strings.TrimSpace(os.Getenv("ANTRAGSERVICE_CORS_ALLOWED_ORIGINS"))
	credentialsEnv := strings.TrimSpace(os.Getenv("ANTRAGSERVICE_CORS_ALLOW_CREDENTIALS"))
